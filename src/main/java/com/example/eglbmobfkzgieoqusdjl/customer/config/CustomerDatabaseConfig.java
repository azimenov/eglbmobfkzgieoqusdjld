package com.example.eglbmobfkzgieoqusdjl.customer.config;
...
@EnableJpaRepositories(
        ...
        basePackages 	 = {"com.example.eglbmobfkzgieoqusdjl.customer.repository"},
...
public class CustomerDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManager() {
        ...
        bean.setPackagesToScan("com.example.eglbmobfkzgieoqusdjl.customer.model");
        return bean;
    }
